function generateLeftHero() {
  ...
  svg.appendChild(
    rc.line(
      offset.outerBox.x +
        offset.textBlock.x +
        dimension.outerBox.width +
        swingEntropy(20),
      offset.outerBox.y + offset.textBlock.y,
      offset.outerBox.x +
        offset.textBlock.x +
        dimension.outerBox.width +
        dimension.textBlock.width +
        swingEntropy(20),
      offset.outerBox.y + offset.textBlock.y,
      {
        stroke: "black",
  ...
  const boxDimensions = dimensionTransform(
    [
      {
        x: offset.outerBox.x > 15 ? offset.outerBox.x - 15 : 0,
        y: offset.outerBox.y > 15 ? offset.outerBox.y - 15 : 0,
      },
    ],
    {
      width: dimension.outerBox.width + dimension.textBlock.width + 100,
      height: dimension.outerBox.height + 30,
    }
  );
